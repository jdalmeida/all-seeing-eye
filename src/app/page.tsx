...
import { NewsCLI } from "@/app/_components/news-cli";
          ...
          <main className="relative h-screen overflow-hidden flex flex-col items-center justify-center px-4">
            ...
            <div className="relative z-10 text-center">
              ...
              <SignInButton mode="modal">
                <button
                  type="button"
                  className="px-6 py-2 bg-primary text-black font-bold border border-primary hover:bg-primary-hover hover:glow-on-hover transition-all"
                >
                  [ACESSAR]
                </button>
              </SignInButton>
            ...
            {/* Terminal CLI (visível mesmo sem login) */}
            <NewsCLI />
          </main>
        </SignedOut>
      </div>
